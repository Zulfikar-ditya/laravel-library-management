    ...
    <div class="row justify-content-around mb-5">
        <div class="col-md-4">
            <ul class="list-group text-capitalize">
                ...
                <li class="list-group-item">List Borrowing
                    <a href="{{ route('listBorrow') }}" class="btn btn-sm btn-outline-info float-right">
                        Go To Page
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-up-right"
                            fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <li class="list-group-item">return book
                    <a href="{{ route('returnBook') }}" class="btn btn-sm btn-outline-info float-right">
                        Go To Page
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-up-right"
                            fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <li class="list-group-item">extension borrow
                    <a href="{{ route('BorrowingExtentionsInput') }}" class="btn btn-sm btn-outline-info float-right">
                        Go To Page
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-up-right"
                            fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
